...
> **⚠ 공개 저장소로 운영 중이면 반드시 마스킹 모드를 쓴다.**
> 워크플로가 저장소 공개 여부를 감지해 `--mask` 를 자동 적용하고,
> 개인 성명을 가린 채 기록하며 DOCX Artifact 업로드를 생략한다.
> 제출용 원본은 로컬에서 생성한다. → [source/README.md](source/README.md)
>
> **원칙적으로는 private 운영을 권한다.** 참여인력·평가위원의 성명과 생년월일,
